...
export const items = [
    {
        ...
        location: 'Scotts Valley, CA/Remote',
        link: 'https://shr.ucsc.edu/',
        content: 'I had the opportunity to work under the Human Resources Business Information Services (HRBIS) department and the Business Administrative, Policy, Projects and Resources (BAPPR) department at UC Santa Cruz. I led and trained a team of students on a project to update the web pages on the staff human resource website. Together, we scheduled and led meetings to review web page contents, understood policies, and communicated with subject matter experts to ensure that pages were up to date. We also learned to use the campus Web Content Management System (WCMS) to edit and process updates to our web pages, reviewed the HTML source codes to ensure consistency in styling, and examined ways to improve accessibility, such as implementing analyzing site navigation. Due to remote work conditions, I implemented a project management tool to keep track of the team\'s tasks and progresses on various web pages. We were able to update more than 60% of the entire HR website and resolved over 50 web support tickets through the Information Technology Services Request Ticketing System, tackling problems, such as tracking the source of broken links then locating the correct links, and removing duplicate web contents. Aside from the web update project, I also automated some processes for generating reports with data from several Excel workbooks by writing Python scripts. Through this experience, I learned the responsibilities of being a project leader, implemented solutions to uprising problems, worked with teams and leaders in a professional setting, and utilized different resources to solve problems.'
    },
    {
        logo: DGLogo,
